...
naive_epsilon <- function(I, Rt_epi, periods){
  ...
  for (k in 1:length(epsilon$sum_epsilon)){
    ...
    epsilon$sum_epsilon[[k]][1,2:4] <- sum_epsi_national
    epsilon$sum_epsilon[[k]][2:ncol(I[[1]]),2:4] <- sum_epsi_geo
...
saveRDS(object = naive_epsilon_fr, file = 'Rdata/naive_epsilon_fr.rds')
saveRDS(object = naive_epsilon_UK1, file = 'Rdata/naive_epsilon_UK1.rds')
saveRDS(object = naive_epsilon_UK2, file = 'Rdata/naive_epsilon_UK2.rds')
