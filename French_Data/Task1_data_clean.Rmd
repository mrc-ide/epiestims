...
saveRDS(object = Epi_param, file = 'Rdata/Epi_param.rds')
saveRDS(object = I_fr, file = 'Rdata/I_fr.rds')
saveRDS(object = I_UK1, file = 'Rdata/I_UK1.rds')
saveRDS(object = I_UK2, file = 'Rdata/I_UK2.rds')

saveRDS(list(periods_fr = periods_fr,
             periods_UK1 = periods_UK1,
             periods_UK2 = periods_UK2), file = 'Rdata/periods.rds')
```
