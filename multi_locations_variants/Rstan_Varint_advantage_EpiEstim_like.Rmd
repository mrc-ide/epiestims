...
temp <- matrix(param_Rt$shape,
               ...
               ncol = n_location)
temp <- 1/matrix(param_Rt$shape,
                 nrow = as.integer(dim(mI)[2]), 
                 ncol = n_location)
# mean(rgamma(1e4,shape = param_Rt$shape,scale = param_Rt$scale))
# sd(rgamma(1e4,shape = param_Rt$shape,scale = param_Rt$scale))
...
standata <- list(nt = as.integer(dim(mI)[2]),
                 ...
                 prior_shape = matrix(param_Rt$shape,
                                      nrow = as.integer(dim(mI)[2]), 
                                      ncol = n_location),
                 prior_rate = 1/matrix(param_Rt$scale,
                                       nrow = as.integer(dim(mI)[2]), 
                                       ncol = n_location),
