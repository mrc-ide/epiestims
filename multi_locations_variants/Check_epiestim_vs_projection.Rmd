...
for(i in 1:4){
  ...
  weekly_Rt_EpiEstim[[i]] <- weekly_res
...
# save Epiestim output

```{r}

Post_Epiestim <- list(daily_Rt_EpiEstim = daily_Rt_EpiEstim,
                      weekly_Rt_EpiEstim = weekly_Rt_EpiEstim,
                      SI_sim = SI_sim,
                      I = I,
                      mean_prior = mean_prior,
                      std_prior = std_prior,
...
saveRDS(Post_Epiestim, file = 'EpiEstim.rds')
```
